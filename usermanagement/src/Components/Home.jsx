...
<h2 className="fw-bold mb-4">Dashboard Overview</h2>
  ...
  <div className="card border-0 shadow-lg rounded-4 bg-primary-subtle text-primary">
    <div className="card-body d-flex justify-content-between align-items-center p-4">
      ...
      <i className="bi bi-people-fill fs-1 opacity-75"></i>
        ...
        {/* ACTIVE */}
        <div className="col-md-4">
          <div className="card border-0 shadow-lg rounded-4 bg-success-subtle text-success">
            <div className="card-body d-flex justify-content-between align-items-center p-4">
              <div>
                <h6>Active Users</h6>
        ...
        {/* INACTIVE */}
        <div className="col-md-4">
          <div className="card border-0 shadow-lg rounded-4 bg-danger-subtle  text-danger">
            <div className="card-body d-flex justify-content-between align-items-center p-4">
              <div>
